...
import ContactImge from '/Contact.png'
...
import { FaPlaneDeparture, FaCarSide } from "react-icons/fa";
...
const About = () => {
  return (
    <>
      ...
      <section className="mt-20 px-4 md:px-10 max-h-screen mb-28">
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_2.5fr] rounded-2xl">
          ...
          <div className="w-full bg-cover bg-center rounded-r-2xl" style={{ backgroundImage: `url(${ContactBg})` }}>
            <img src={ContactImge} alt="" className='object-cover' />
          </div>
        </div>
      </section>

      {/* Explore Section */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-6 lg:px-20 py-16">
        {/* Left */}
        <div className="">
          <h1 className="font-bold text-3xl md:text-4xl">Explore Nearby</h1>
          <p className="mt4">Check out beautiful places around the world</p>
          <img src={Explore} alt="" className='mt-6 w-2/3 rounded-lg object-cover' />
        </div>
        {/* Right */}
      ...
      {/* Testimonial Section */}
      <section className="">
        {/* Testimonials Carousel here later */}
      </section>
